...
sc failure $SVC_SERVER reset= 86400 actions= restart/30000/restart/60000/restart/60000 >$null
sc failureflag $SVC_SERVER 1 >$null
...
sc failure $SVC_AGENT reset= 86400 actions= restart/60000/restart/90000/restart/120000 >$null
sc failureflag $SVC_AGENT 1 >$null
...
sc failure $SVC_WATCHDOG reset= 86400 actions= restart/15000/restart/30000/restart/30000 >$null
sc failureflag $SVC_WATCHDOG 1 >$null
...
Write-Host "==================================================================="
Write-Host ""
Write-Host "  NOTE: If LAN backup fails with access denied, the services"
Write-Host "  must run as a domain user with network share access."
Write-Host "  Configure via services.msc -> Log On tab."
Write-Host ""
pause
