...
class TestRunLanDryRun:
    ...
    def test_exit_0_returns_ok(self, mock_run):
    ...
    @patch("core.lan_preflight.subprocess.run")
    def test_exit_7_returns_ok(self, mock_run):
    ...
    @patch("core.lan_preflight.subprocess.run")
    def test_exit_8_returns_not_ok(self, mock_run):
        """Bit 3 (8) = copy errors."""
    ...
    @patch("core.lan_preflight.subprocess.run")
    def test_exit_16_returns_not_ok(self, mock_run):
    ...
    @patch("core.lan_preflight.subprocess.run")
    def test_robocopy_not_found(self, mock_run):
